...
// Jika Tambah ke Keranjang dipencet
if (isset($_POST['add_to_cart'])) {
    $id = $_POST['menu_id'];
    $jumlah = (int)$_POST['jumlah'];
    
    // Ambil detail menu dari DB
...
<body>
    ...
    <table border="1" cellpadding="8" cellspacing="0">
        <tr><th>Nama Makanan</th><th>Harga</th><th>Jumlah</th><th>Aksi</th></tr>
    ...
    <br>
    <a href="http://minuman.sederhanaok.com/minuman.php"><button>🥤 Ke Menu Minuman</button></a>
